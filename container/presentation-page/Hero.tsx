...
export default function Hero() {
	return (
		<section className="w-full padding-x bg-black sticky top-0 h-[65vh]">
			<div className="w-full pt-[170px] pb-[20px]">
				<div className="w-fit relative">
					<h1 className="heading tracking-[-1.3px] text-slate-100 font-semibold font-FoundersGrotesk uppercase">
					Bombin' works
